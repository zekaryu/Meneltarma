...
public class CLH {
  ...
  private CLH() {
    ...
    this.myreq = new ThreadLocal<Request>() {
      ...
      protected Request initialValue() {
        return new Request(State.PENDING);
      }
    };
  ...
  public static void main(String[] args) throws InterruptedException {
    CLH clh = new CLH();
    Process process1 = new Process(clh);
    Process process2 = new Process(clh);
    Process process3 = new Process(clh);
    Process process4 = new Process(clh);
